  ...
  return (
    <main>
      ...
      <section className="bg-base-200">
        <div className="max-w-3xl mx-auto max-w-5xl flex flex-row justify-between items-center px-8 py-2">
      ...
      <section className="bg-base-200 py-32" id="pricing">
        <div className="py-32 px-8 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl lg:test-4xl font-extrabold mb-12 text-center">
      ...
      <section className="bg-base-200 py-32" id="faq">
        <div className="py-32 px-8 max-w-3xl mx-auto">
          ...
          <ul className="list-none max-w-lg mx-auto">
            {[
